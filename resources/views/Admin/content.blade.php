...
<div class="content-wrapper">
  ...
  <div class="row">
    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
      <div class="card">
        <a href="{{route('admin.schedule.index')}}" style="color: white !important;    text-decoration: none !important;">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
      ...
      <div class="card ml-4">
        <a href="{{route('admin.patient.index')}}" style="color: white !important; text-decoration: none !important;">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
      ...
      <div class="card ml-4">
        <a href="{{route('admin.doctor.index')}}" style="color: white !important;    text-decoration: none !important;">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
